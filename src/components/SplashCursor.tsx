...
export default function SplashCursor({
    ...
    `
        ...
        function generateColor(): ColorRGB {
            // Constrain hue to Blue/Purple/Pink range (approx 0.55 to 0.85)
            // This creates a palette of deep blues, indigos, purples, and intense pinks
    ...
    return (
        <div className="fixed top-0 left-0 z-1 pointer-events-none w-full h-full opacity-40">
