                    ...
                    <form onSubmit={handleSubmit}>
                        <CardContent className="space-y-5">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                ...
                                <Button variant="outline" type="button" className="h-10 bg-white/5 border-white/10 hover:bg-white/10 hover:text-white transition-all rounded-lg text-xs font-medium" onClick={() => window.location.href = `${import.meta.env.VITE_API_URL || 'http://localhost:8080'}/auth/google/login`}>
